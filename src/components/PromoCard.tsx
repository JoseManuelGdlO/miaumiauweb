...
const PromoCard = ({ promotion }: PromoCardProps) => {
  ...
  return (
    <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${promotion.bgColor} p-6 md:p-8 text-white shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]`}>
      {/* Decorative circle */}
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between gap-4 mb-3">
          <span className="text-4xl">{promotion.image}</span>
